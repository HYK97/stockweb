...
public class CommuController {
	...
	public String viewContent(HttpSession session, int id) {
		...
		if (session.getAttribute("login") == null) {
			user.setId("");
			log.info("---------------���̵� : " + Long.valueOf(id) + "---------------�������̵���϶� : " + user.getId());
		} else {
			session.setAttribute("login", session.getAttribute("login"));
			user = (UserDto) session.getAttribute("login");
			log.info("---------------���̵� : " + Long.valueOf(id) + "---------------�������̵�ξƴҶ� : " + user.getId());
		}
		log.info("---------------���̵� : " + Long.valueOf(id) + "---------------�������̵���ü�� : " + user.getId());
	...
	public String write(HttpServletRequest request, CommunityDto com, HttpSession session, List<MultipartFile> uploadFile) {
		...
		log.info("��Ʈ�ѷ�------" + com.getImglists().toString());
		service.write(com);
		session.setAttribute("login", session.getAttribute("login"));
	...
	public String header() {
		...
		try {
			...
			List<Element> up1 = doc.select("#siselist_tab_0 tbody .tltle");//���ϴ� �±� ����
			Elements up2 = doc.select("#siselist_tab_0 tbody .number .tah");//���ϴ� �±� ����

			List<Element> down1 = doc.select("#siselist_tab_1 tbody .tltle");//���ϴ� �±� ����
...
//		for (String L: sdown1)
//		{
//			log.info("sdown1Ȯ�� _-----------------: " +L);
//			
//		}
//		for (String L: sdown2)
//		{
//			log.info("sdown2Ȯ�� _-----------------: " +L);
//			
//		}
