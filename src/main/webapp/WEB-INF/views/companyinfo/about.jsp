...
<body
        class="home page-template-default page page-id-9 _masterslider _msp_version_3.2.2 wpb-js-composer js-comp-ver-5.4.5 vc_responsive no-transform"
        itemscope="itemscope" itemtype="https://schema.org/WebPage" data-adminbar="">
<!-- Target for scroll anchors to achieve native browser bahaviour + possible enhancements like smooth scrolling -->
<div id="top-of-page"></div>
<div id="mk-boxed-layout">
    <div id="mk-theme-container" class="trans-header">
        <header data-height="90" data-sticky-height="80" data-responsive-height="90" data-transparent-skin="light"
                data-header-style="1" data-sticky-style="fixed" data-sticky-offset="header" id="mk-header-1"
                class="mk-header header-style-1 header-align-left toolbar-false menu-hover-1 sticky-style-fixed mk-background-stretch boxed-header transparent-header light-skin bg-true"
                ...
                <div class="mk-header-inner add-header-height">
                    ...
                    <div class="mk-grid header-grid">
                        ...
                        <div class=" header-logo fit-logo-img add-header-height  ">
                            <a href="/" title="Jutopia 정보">
                                <img class="mk-desktop-logo dark-logo " title="StockTwits 정보" alt="Jutopia 정보"
                                     src="../../../resources/img/logo2.png">
                                <img class="mk-desktop-logo light-logo " title="StockTwits 정보" alt="StockTwits 정보"
                ...
                <div id="mk-page-id-9" class="theme-page-wrapper mk-main-wrapper mk-grid full-layout no-padding">
                    <div class="theme-content no-padding" itemprop="mainEntityOfPage">
                        <div class="mk-page-section-wrapper" data-mk-full-width="true" data-mk-full-width-init="true"
                             ...
                             style="position: relative; box-sizing: border-box; width: 1225px; left: -47.5px;">
                            <div id="page-section-2"
                                 ...
                                 data-mk-component="FullHeight" data-fullheight-config="{&quot;min&quot;: 500}"
                                 data-intro-effect="false" style="min-height: 977px;">
                                <div class="mk-page-section-inner">
                                    ...
                                    <div class="background-layer-holder">
                                        <div id="background-layer--2" data-mk-lazyload="false"
                                             ...
                                             mk-img-loaded=""
                                             style="background-image: url(&quot;../../../resources/img/team.jpg&quot;); background-attachment: scroll; will-change: transform;">
                                ...
                                <div class="page-section-content vc_row-fluid mk-grid ">
                                    <div class="mk-padding-wrapper wpb_row">
                                        <div class="vc_col-sm-12 wpb_column column_container   _ height-full">
                                            ...
                                            <div id="mk-gradient-button-5"
                                                 class="mk-gradient-button fullwidth-false btn-align-center custom-width-true">
                                                <a href="/user/register"
                                                   class="mk-button mk-button--dimension-two mk-button--size-large mk-button--corner-full_rounded light-skin"
                                                   target="_self">
                                                            <span class="text">
                                                                <font style="vertical-align: inherit;">
                        ...
                        <div data-mk-full-width="true" data-mk-full-width-init="true" data-mk-stretch-content="true"
                             ...
                             style="position: relative; box-sizing: border-box; width: 1225px; left: -62.5px;">
                            <div class="vc_col-sm-12 wpb_column column_container   _ height-full">
                        ...
                        <div data-mk-stretch-content="true"
                            ...
                            <div class="vc_col-sm-6 wpb_column column_container   _ height-full">
                                ...
                                <div class=" vc_custom_1563390829330">
                                    <div id="text-block-11" class="mk-text-block   ">
                                        <p>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Jutopia는 5 백만 명 이상의 커뮤니티 회원과 수백만
                                                    명의 월간 방문자를 보유한 투자자 및 거래자를위한 최대 규모의 소셜 네트워크입니다.
                                                </font>
                                                <font style="vertical-align: inherit;">Jutopia는 일반 투자자와 상인을 서로 연결하여 수익을
                                                    올리고 배우고 재미있게 즐길 수 있도록 2020 년에 설립되었습니다.</font>
                                            </font>
                                        </p>
                                        <p>
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;">Jutopia는 Twitter 플랫폼에 구축 된 간단한
                                                    앱으로 시작했지만 캐시 태그 (예 :
                                                </font>
                                            </font>
                                            <a id="AAPL-1-122" href="/community/chart?search=034220" data-event="click"
                                               data-for="cashTag" data-tip="AAPL">
                                                <font style="vertical-align: inherit;">
                                            ...
                                            <font style="vertical-align: inherit;">
                                                ...
                                                <font style="vertical-align: inherit;">"사회 금융"을 정의하는 목소리 인 Jutopia는 관심있는
                                                    시장과 주식에서 지금 무슨 일이 일어나고 있는지 파악하는 가장 좋은 방법이며, 차세대 투자자를 위해 금융 미디어를 재
                                                    구상하고 있습니다.</font>
                                            </font>
                                        </p>
                                        <div class="clearboth"></div>
                            ...
                            <div class="vc_col-sm-5 wpb_column column_container   _ height-full">
                                <div class="mk-image mk-image-15   align-left simple-frame inside-image "
                                     style="margin-bottom:10px">
                                    <div class="mk-image-container" style="max-width: 626px;">
                                        <div class="mk-image-holder" style="max-width: 626px;">
                                            <div class="mk-image-inner  "><img class="lightbox-false" alt="Jutopia 앱"
                                                                               title="Jutopia 앱" width="626"
                                                                               height="1248"
                                                                               src="../../../resources/img/companyphone.png">
                                            </div>
                                        </div>
                                        <div class="clearboth"></div>
                                    </div>
                        ...
                        <div data-mk-stretch-content="true"
                            ...
                            <div class="vc_col-sm-4 wpb_column column_container   _ height-full">
                                <div id="milestone-21"
                                     class="mk-milestone milestone-large center-align scroll-animated">
                                    <i>
                                        <svg class="mk-svg-icon" data-name="mk-icon-users"
                                             data-cacheid="icon-60aaff906a708" style=" fill: #00baff; "
                                             xmlns="http://www.w3.org/2000/svg" viewbox="0 0 1920 1792">
                                    ...
                                    <div class="milestone-top">
                                                <span style="color:#33435e;font-size:78px;font-weight:300"
                                                      class="milestone-number" data-speed="600" data-stop="5">
                                                    <font style="vertical-align: inherit;">
                                                        <font style="vertical-align: inherit;">5</font>
                                                    </font>
                                                </span>
                                        <span style="color:#33435e;font-size:78px;font-weight:300"
                                              class="milestone-suffix">
                                                    <font style="vertical-align: inherit;">
                            ...
                            <div class="vc_col-sm-4 wpb_column column_container   _ height-full">
                                <div id="milestone-23"
                                     class="mk-milestone milestone-large center-align scroll-animated">
                                    <i>
                                        <svg class="mk-svg-icon" data-name="mk-icon-comments-o"
                                             data-cacheid="icon-60aaff906ab18" style=" fill: #00baff; "
                                    ...
                                    <div class="milestone-top">
                                                <span style="color:#33435e;font-size:78px;font-weight:300"
                                                      class="milestone-number" data-speed="600" data-stop="7">
                                                    <font style="vertical-align: inherit;">
                            ...
                            <div class="vc_col-sm-4 wpb_column column_container   _ height-full">
                                <div id="milestone-25"
                                     class="mk-milestone milestone-large center-align scroll-animated">
                                    <i>
                                        <svg class="mk-svg-icon" data-name="mk-li-apeaker"
                                             data-cacheid="icon-60aaff906ae91" style=" fill: #00baff; "
                            ...
                            <div class="vc_col-sm-6 wpb_column column_container   _ height-full">
                                ...
                                <div class="wpb_row vc_inner vc_row vc_row-fluid    attched-false   ">
                                    <div class="wpb_column vc_column_container vc_col-sm-3">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="mk-image mk-image-33   align-center simple-frame inside-image "
                                                     style="margin-bottom:50px">
                                                    <div class="mk-image-container" style="max-width: 160px;">
                                                        <div class="mk-image-holder" style="max-width: 160px;">
                                                            <div class="mk-image-inner  ">
                                                                <a href="https://www.kiwoom.com/&quot;" target="_blank"
                                                                   class="mk-image-link"><img class="lightbox-false"
                                                                                              alt="키움증권" title="키움증권"
                                                                                              width="160" height="61"
                                                                                              src="../../../resources/img/키움증권.JPG"></a>
                                                            </div>
                                                        </div>
                                                        <div class="clearboth"></div>
                                                    </div>
                                            ...
                                            <div class="wpb_wrapper">
                                                <div class="mk-image mk-image-33   align-center simple-frame inside-image "
                                                    ...
                                                    <div class="mk-image-container" style="max-width: 160px;">
                                                        <div class="mk-image-holder" style="max-width: 160px;">
                                                            <div class="mk-image-inner  ">
                                                                <a href="https://www.onestopsamsungpop.co.kr/home/stock/?skipSection=forever&amp;utm_source=google&amp;utm_medium=pc-sa&amp;utm_campaign=account&amp;utm_content=brand&amp;utm_term=%EC%82%BC%EC%84%B1%EC%A6%9D%EA%B6%8C&amp;EKAMS=google.1089.7298.23699.2092629.620010558&amp;trackingDays=30"
                                                                   target="_blank" class="mk-image-link"><img
                                                                        class="lightbox-false" alt="삼성증권" title="삼성증권"
                                                                        width="160" height="61"
                                                                        src="../../../resources/img/삼성증권.JPG"></a>
                                                            </div>
                                                        </div>
                                                        <div class="clearboth"></div>
                                                    </div>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="mk-image mk-image-34   align-center simple-frame inside-image "
                                                     style="margin-bottom:10px">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-3">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="mk-image mk-image-35   align-center simple-frame inside-image "
                                                     style="margin-bottom:10px">
                                                    <div class="mk-image-container" style="max-width: 300px;">
                                                        <div class="mk-image-holder" style="max-width: 300px;">
                                                            <div class="mk-image-inner  ">
                                                                <a href="https://www.wadiz.kr/web/wsub/openfunding/reward?utm_source=rwm_gdn&amp;utm_medium=search&amp;utm_campaign=PC_%EB%A9%94%EC%9D%B4%EC%BB%A4&amp;utm_content=PC_00.%EC%99%80%EB%94%94%EC%A6%88&amp;utm_term=%EC%99%80%EB%94%94%EC%A6%88&amp;gclid=CjwKCAjw-qeFBhAsEiwA2G7NlxhkBNLBiOh0gkysHMUhtw1f2xb4POEb-n63_fuDa11qzGz0lBTTRhoC18cQAvD_BwE"
                                                                   target="_blank" class="mk-image-link"><img
                                                                        class="lightbox-false"
                                                                        alt="스크린 샷 -2020-03-27-at-3.59.39-pm"
                                                                        title="스크린 샷 -2020-03-27-at-3.59.39-pm"
                                                                        width="300" height="300"
                                                                        src="../../../resources/img/와디즈.jpg"></a>
                                                            </div>
                                                        </div>
                                                        <div class="clearboth"></div>
                                                    </div>
                        ...
                        <section id="nav_menu-2" class="widget widget_nav_menu mk-in-viewport">
                            ...
                            <div class="menu-main-menu-container">
                                <ul id="menu-main-menu-2" class="menu">
                                    <li id="menu-item-14"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-9 current_page_item menu-item-14">
                                        <a href="/companyinfo/about" aria-current="page">
                                            <svg class="mk-svg-icon" data-name="mk-icon-angle-right"
                                                 data-cacheid="icon-60aaff90706e6" style=" height:14px; width: 5px; "
                        ...
                        <section id="social-2" class="widget widget_social_networks mk-in-viewport">
                            ...
                            <div id="social-60aaff9070a9d" class="align-left">
                                <a href="https://facebook.com" rel="nofollow"
                                   class="builtin-icons dark medium facebook-hover" target="_blank"
                                   alt="페이스 북으로 우릴 팔로우 해" title="페이스 북으로 우릴 팔로우 해">
                                    <svg class="mk-svg-icon" data-name="mk-jupiter-icon-simple-facebook"
                                         data-cacheid="icon-60aaff9070c1d" style=" height:24px; width: 24px; "
                                         xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
                                ...
                                <a href="https://www.instagram.com" rel="nofollow"
                                   class="builtin-icons dark medium instagram-hover" target="_blank"
                                   alt="Instagram에서 팔로우" title="Instagram에서 팔로우">
                                    <svg class="mk-svg-icon" data-name="mk-jupiter-icon-simple-instagram"
                                         data-cacheid="icon-60aaff9070d31" style=" height:24px; width: 24px; "
                                         xmlns="http://www.w3.org/2000/svg" viewbox="0 0 81.2 81.2">
                                ...
                                <a href="https://twitter.com" rel="nofollow"
                                   class="builtin-icons dark medium twitter-hover" target="_blank" alt="트위터에서 우리를 따르라"
                                   title="트위터에서 우리를 따르라">
                                    <svg class="mk-svg-icon" data-name="mk-jupiter-icon-simple-twitter"
                                         data-cacheid="icon-60aaff9070e22" style=" height:24px; width: 24px; "
                                         xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512">
...
<div class="bottom-corner-btns js-bottom-corner-btns">
    <a href="#top-of-page" class="mk-go-top js-smooth-scroll js-bottom-corner-btn js-bottom-corner-btn--back is-active">
        <svg class="mk-svg-icon" data-name="mk-icon-chevron-up" data-cacheid="icon-60aaff90728ba"
