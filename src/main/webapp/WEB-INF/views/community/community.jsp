                    ...
                    <div style="display: block; margin-left: auto; margin-right: auto;">
                        <div style="margin-bottom: 1.5%;">
                            <ul
                                ...
                                <li>
                                    <a href="#" class="nav-link px-2 link-dark">오늘의 추천주</a>
                                </li>
                                <li>
                                    <a href="#" class="nav-link px-2 link-dark">커뮤니티</a>
                                </li>
                                <li>
                        ...
                        <div id="kk"style="display: flex;  border-top: 1px solid #dee2e6;">
                            <div style="margin-right: 10px;">
                                <ul
                                    class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 text-center">
                                    <li>
                            ...
                            <div
                                style="display: flex; justify-content: center; align-items: center; padding-left: 10px; border-left: 1px solid #dee2e6; border-radius: 1.5em;  border-right: 1px solid #dee2e6;">
                                <label>롤링</label>
                                <button style="background :transparent; border-color: transparent;">
                                    <img style="width: 20px;" src="../../../resources/img/run.png" alt="">
                                </button>
                            </div>
                            <div>
                                <ul
                                    ...
                                    <li>
                                        <a href="#" class="nav-link px-2 link-dark">
                                            <div>삼성전자</div>
                                            <div style="color: green;">%7.7</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-2 link-dark">
                                            <div>신라젠</div>
                                            <div style="color: red;">-5.2%</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-2 link-dark">
                                            <div>셀트리온</div>
                                            <div style="color: green;">8.1%</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-2 link-dark">
                                            <div>lg화학</div>
                                            <div style="color: green;">15.3%</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-2 link-dark">
