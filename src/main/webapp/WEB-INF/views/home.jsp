...
<header class="p-3 mb-3 border-bottom"
        style="z-index: 1;position: sticky;top: 0px;background-color: white;margin: 0;padding-top: 5px!important;padding-bottom: 9px!important;">
                        ...
                        <div style="display: flex;">
                            <div style="margin: 0 3%">
                                <a href="/user/register">
                                    <button class="lib_2cF8aMP lib_c4bD4Or lib_2ybS2EZ lib_3NGW_J6 lib_2q7AR4x lib_3kUdsG1 lib_3Z398za lib_2WawZPB lib_2bmVxh4 lib_3PxyMmd lib_q275ObV lib_JZxvQws lib_3RwLEdi lib_yW5-oZX lib_c4bD4Or">
                                        회원가입
                                    </button>
                                </a>
                            </div>
                            <div style="margin: 0 3%">
                                <a href="/user/login">
                                    <button class="lib_2cF8aMP lib_c4bD4Or lib_2ybS2EZ lib_3NGW_J6 lib_2q7AR4x lib_3kUdsG1 lib_3Z398za lib_2WawZPB lib_2bmVxh4 lib_3PxyMmd lib_q275ObV lib_3-XmGDP lib_12C0HKX lib_3wnZQA7">
                                        로그인
                                    </button>
                                </a>
                            </div>
            ...
            <div class="st_2eXbCFU st_jGV698i st_1GuPg4J st_3tuT9Yf st_3QTv-Ni st_Qu5atwI">
                ...
                <div class="st_2tRlQcD st_1w3Pise st_2mehCkH st_3PPn_WF st_1tCBfJz">
                    <div class="st_206E10N st_8u0ePN3">
                        <a href="/user/register">
                            <button
                                    class="lib_2cF8aMP lib_c4bD4Or lib_2ybS2EZ lib_3NGW_J6 lib_2q7AR4x lib_3kUdsG1 lib_3Z398za lib_2WawZPB lib_2bmVxh4 lib_3PxyMmd lib_31F_UHw lib_3-XmGDP lib_12C0HKX lib_3wnZQA7">
                                회원가입
                            </button>
                        </a>
                    </div>
                ...
                <div class="lib_1Hrnkmu">
                    <div class="lib_1gWiiBf lib_2S7tmc- lib_65XwjLA lib_1XCy-SC">
                        <ul
                            ...
                            <li>
                                <a class="lib_1Nq1Qic lib_3RwLEdi" href="mailto:ddh963963@naver.com"><font
                                        style="vertical-align: inherit;"><font
                                        style="vertical-align: inherit;">광고문의</font></font></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="lib_VbRVgfB lib_3UzYkI9 lib_iAc2fkL lib_2p_jTmF lib_23WxpCB lib_2gU77Qd lib_2S7tmc- lib_65XwjLA lib_1XCy-SC">
                            <li>
                                <a href="https://twitter.com/" rel="noopener" target="_blank"
                                   class="lib_3j2aFgq lib_1LUBAjF lib_3Bez1rH lib_2jbIWTp lib_3kUdsG1">
                            ...
                            <li>
                                <a href="https://facebook.com/" rel="noopener" target="_blank">
                                    <svg class="lib_1e7YeD3 lib_3NGW_J6 lib_2jbIWTp lib_2bmVxh4 lib_1LUBAjF"
