...
<div>
    ...
    <header class="p-3 mb-3 border-bottom"
            style="line-height: 1.3em;z-index: 2;position: sticky;top: 0px;background-color: white;margin: 0;padding-top: 5px!important;padding-bottom: 9px!important;">
                ...
                <div style="width: 60%;display: block;margin-left: auto;margin-right: auto;height: 140p;">
                    <div style="margin-bottom: 1.5%;">
                        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 mb-md-0"
                            ...
                            <li>
                                <a href="/user/likeContent" class="nav-link px-2 link-secondary">좋아요 글</a>
                            </li>
                            <li>
